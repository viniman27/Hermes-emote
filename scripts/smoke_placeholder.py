...
Isola o mecanismo de placeholder do prompt_toolkit. Transmite a Hermes idle com
...
Rodar DENTRO do Ghostty:
    python3 ~/.hermes/plugins/hermes-emote/scripts/smoke_placeholder.py
"""
import sys
...
IMG = PLUGIN / "emotes" / "Hermes" / "idle" / "idle.png"
...
def main():
    ...
    sys.stdout.flush()
    print("\n^ apareceu a Hermes idle? (s = placeholders OK / n = Ghostty sem suporte)")
